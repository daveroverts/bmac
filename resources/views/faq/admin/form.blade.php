            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="question" type="text"
                                    ...
                                    name="question" value="{{ old('question', $faq->getRawOriginal('question')) }}"
                                    required>
                        ...
                        <div>
                            <textarea class="tinymce" name="answer" rows="10">{!! html_entity_decode(old('answer', $faq->answer)) !!}</textarea>
