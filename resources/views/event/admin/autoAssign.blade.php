    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('booking.admin.autoAssign',$event->id) }}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" id="route1"
                                          name="route1">{{ old('route1') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" id="route1"
                                          name="route2">{{ old('route2') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="minFL" type="text"
                                       class="form-control{{ $errors->has('minFL') ? ' is-invalid' : '' }}"
                                       name="minFL"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="maxFL" type="text"
                                       class="form-control{{ $errors->has('maxFL') ? ' is-invalid' : '' }}"
                                       name="maxFL"
