            ...
            <div class="card">
                ...
                <div class="card-body">
                    <x-form :action="$eventLink->id
                        ...
                        @bind($eventLink)
                            <x-form-select name="event_link_type_id" :label="__('Type')" :options="$eventLinkTypes" :placeholder="__('Choose...')"
                                required />
                            @if ($eventLink->id)
                            ...
                            @else
                                <x-form-select name="event_id" :label="__('Event')" :options="$events" :placeholder="__('Choose...')" required />
                            @endif
